...
class OriginCreateView(CreateView):
    ...
    success_url = reverse_lazy("diaryapp:origin_list")
...
class OriginUpdateView(UpdateView):
    ...
    success_url = reverse_lazy("diaryapp:origin_list")
    template_name = "diaryapp/origin_update_form.html"
    ...
    def _process_start_quest(origin_name: str):
        ...
        origin.save()
        return redirect(reverse("diaryapp:quest_list"))
...
class QuestCreateTemplateView(TemplateView):
    template_name = "diaryapp/quest_form.html"
    
    def get(self, request, *args, **kwargs):
        default_origin = self._extract_actual_origin()
        if default_origin is None:
            return redirect(reverse("diaryapp:origin_list"))
...
class QuestListView(ListView):
    ...
    template_name = "diaryapp/quest_list.html"
...
class QuestEditTemplateView(TemplateView):
    template_name = "diaryapp/quest_update_form.html"
...
class DayUpdateView(UpdateView):
    ...
    success_url = reverse_lazy("diaryapp:quest_list")
    context_object_name = "day"

    def get_success_url(self):
        date_value = self.request.POST.get("date")

        base_url = reverse("diaryapp:quest_list")
